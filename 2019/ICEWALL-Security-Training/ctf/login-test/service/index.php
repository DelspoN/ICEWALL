...
<form class="signUp" id="signupForm" method='post' action='login.php'>
   ...
   <input type="password" name='pw' class="signUpInput" placeholder="Choose a password" required>
   <input type="submit" value="Sign me up!" class="signUpButton">
</form>

<!-- test account: "icewall"/"world-best club" -->
</body>
</html>
